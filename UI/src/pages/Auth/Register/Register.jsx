...
import {
  ...
  MenuItem, Stepper, Step, StepLabel, Modal, Paper, InputAdornment, IconButton
} from "@mui/material";
        ...
        >
          ...
          >
            ...
            <Typography variant="subtitle1">
              Join VinaBooking to discover amazing stays across Vietnam
            </Typography>
          </Box>
          ...
          <Box sx={{ p: 4, bgcolor: '#fff' }}>
            ...
            {activeStep === 0 && (
              <Box>
                <TextField required fullWidth label="Full Name" value={name} onChange={(e) => setName(e.target.value)} 
                  sx={{ mb: 2 }} InputProps={{ sx: { borderRadius: 2 } }} />
                <TextField required fullWidth label="Date of Birth" type="date" InputLabelProps={{ shrink: true }} 
                  value={dob} onChange={(e) => setDob(e.target.value)} sx={{ mb: 2 }} InputProps={{ sx: { borderRadius: 2 } }} />
                <TextField required fullWidth select label="Gender" value={gender} onChange={(e) => setGender(e.target.value)} 
                  sx={{ mb: 2 }} InputProps={{ sx: { borderRadius: 2 } }}>
            ...
            {activeStep === 1 && (
              <Box>
                <MuiTelInput defaultCountry="VN" value={phone} onChange={(value) => setPhone(value)} 
                ...
                />
                <TextField required fullWidth select label="Role" value={role} onChange={(e) => setRole(e.target.value)} 
                  sx={{ mb: 2 }} InputProps={{ sx: { borderRadius: 2 } }}>
            ...
            {activeStep === 2 && (
              <Box sx={{ 
                ...
                <Typography variant="h6" mb={2} color="primary" fontWeight="medium">Review your information:</Typography>
                ...
                <Typography sx={{ mt: 2, fontStyle: 'italic', color: 'text.secondary' }}>
                  Click 'Next' to receive an OTP verification code via email
                </Typography>
              </Box>
            )}
            ...
            {activeStep === 3 && (
              <Box sx={{ textAlign: 'center' }}>
                <Typography variant="h6" color="primary" mb={2}>Verify Your Account</Typography>
                <Typography variant="body1" mb={3}>Enter the 6-digit OTP sent to your email:</Typography>
            ...
            <Modal open={openErrorModal} onClose={handleCloseErrorModal}>
              <Box sx={{ 
                ...
                <Typography variant="h6" sx={{ color: "red", fontWeight: "bold" }}>⚠️ Error</Typography>
            ...
            <Modal open={openSuccessModal} onClose={() => setOpenSuccessModal(false)}>
              <Box sx={{ 
                ...
                <Typography variant="h6" sx={{ color: "green", fontWeight: "bold" }}>✅ Success</Typography>
