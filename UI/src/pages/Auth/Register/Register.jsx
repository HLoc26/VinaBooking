    ...
    <Container maxWidth="md">
      ...
      <Box sx={{ mt: 8, display: "flex", flexDirection: "column", alignItems: "center", boxShadow: 3, p: 4, borderRadius: 2, bgcolor: "#fff", position: "relative" }}>
        ...
        <Modal open={openSuccessModal} onClose={() => setOpenSuccessModal(false)}>
          <Box sx={{ position: "absolute", top: "50%", left: "50%", transform: "translate(-50%, -50%)", width: 400, bgcolor: "background.paper", border: "2px solid green", boxShadow: 24, p: 4, borderRadius: 2 }}>
            ...
            <Button variant="contained" color="success" onClick={() => navigate("/login")} sx={{ mt: 2, width: "100%" }}>
              OK
            </Button>
          </Box>
        </Modal>
